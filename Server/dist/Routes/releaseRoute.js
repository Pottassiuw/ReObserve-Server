...
router.post("/enterprise/:empresaId/user/:usuarioId", (0, authMiddleware_1.requirePermissions)(prisma_1.Permissoes.lancamento), releaseController_1.criarLancamento);
